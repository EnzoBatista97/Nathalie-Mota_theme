        ...
        <div class="photo-details">
            ...
            <div class="photo-details_container">
                ...
                if ($categories && !is_wp_error($categories)) {
                    ...
                    echo '<p class="photo-category">Catégorie : ' . esc_html(implode(', ', $category_names)) . '</p>';
                }
                ...
                if ($formats && !is_wp_error($formats)) {
                    ...
                    echo '<p class="photo-format">Format : ' . esc_html(implode(', ', $format_names)) . '</p>';
                }
        ...
        ?>
                    <div class="related-photo-thumbnail photo-item">
                        <a href="<?php the_permalink(); ?>">
                            ...
                            if ($thumbnail_url) {
                                echo '<img src="' . esc_url($thumbnail_url) . '" alt="' . esc_attr(get_the_title()) . '" class="photo-thumbnail photo-image" />';
                            } else {
                                // Afficher une image de remplacement si aucune miniature n'est disponible
                                echo '<img src="' . esc_url(get_template_directory_uri() . '/images/placeholder.jpg') . '" alt="Placeholder Image" class="photo-thumbnail photo-image" />';
                            }
                            ?>
